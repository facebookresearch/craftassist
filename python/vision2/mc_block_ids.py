...
# If voxel_group is True, then we will merge all voxel ids within the same group
# into a single group id. The idea is that some voxel materials might be semantically
# similar in the context of Minecraft.
voxel_group = False
